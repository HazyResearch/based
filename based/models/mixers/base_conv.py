...
class BaseConv(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # prepare convolution
        self.conv1 = ShortConvolution(self.d_inner, kernel_size=kernel_size, use_cuda=self.use_cuda, layer_idx=(layer_idx, "conv"))
    ...
    def allocate_inference_cache(self, batch_size: int, max_seqlen: int, dtype=None, **kwargs):
        """Creates a state tensor of shape (b, d, k)"""
        return {
            "conv": self.conv1.allocate_inference_cache(batch_size, max_seqlen, dtype=dtype, **kwargs),
        }
